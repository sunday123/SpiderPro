...
public class GatherTest {
	/** 关注列表*/
	private static List<Fan> follow_list= new ArrayList<Fan>();
	/** 粉丝列表*/
	private static List<Fan> followers_list= new ArrayList<Fan>();
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("粉丝的详细数据:");
		 fans_count=fan.getFollowers_count();
...
//			System.out.println(line);
			Boolean b=isJsonObject(line);
//			System.out.println("line:"+isJsonObject(line));
			if(b){
				JSONObject obj = JSON.parseObject(line);
				JSONObject data =(JSONObject) obj.get("data");
				JSONObject user =(JSONObject) data.get("user");
				Fan fan = new Fan(user.getLong("id"), user.getString("screen_name"), user.getString("gender"), user.getInteger("follow_count"), user.getInteger("followers_count"), user.getInteger("statuses_count"), user.getBoolean("verified"), user.getString("description"));;
	          return fan;   
			}else {
				return null;
			}
